 ...
 */
public class KrakenHardware extends OpMode

{
    ...
    double a_left_drive_power ()
    {
        ...
        {
            l_return = v_left_front_drive.getPower ();
        }
    ...
    double a_right_drive_power ()
    {
        ...
        {
            l_return = v_right_front_drive.getPower ();
        }
    ...
    void set_front_drive_power (double p_front_power, double p_rear_power)

    {
        if (v_left_front_drive != null)
        {
            v_left_front_drive.setPower (p_front_power);
        }
        if(v_left_rear_drive != null) {
            v_left_rear_drive.setPower (p_front_power);
        }
        if (v_right_front_drive != null)
        {
            v_right_front_drive.setPower (p_rear_power);
        }
        if(v_right_rear_drive != null) {
            v_right_rear_drive.setPower (p_rear_power);
        }
...

    {
        if (v_left_front_drive != null)
        {
            if (v_left_front_drive.getChannelMode () ==
...

    {
        if (v_right_front_drive != null)
        {
            if (v_right_front_drive.getChannelMode () ==
                DcMotorController.RunMode.RESET_ENCODERS)
            {
                v_right_front_drive.setChannelMode
                    ( DcMotorController.RunMode.RUN_WITHOUT_ENCODERS
    ...
    int a_left_encoder_count ()
    {
        ...
        if (v_left_front_drive != null)
        {
            l_return = v_left_front_drive.getCurrentPosition ();
        }
...

    {
        ...
        if (v_right_front_drive != null)
        {
            l_return = v_right_front_drive.getCurrentPosition ();
        }
...

    {
        ...
        if (v_left_front_drive != null)
        {
            ...
            //
            if (Math.abs (v_left_front_drive.getCurrentPosition ()) > p_count)
            {
                //
...

    {
        ...
        if (v_right_front_drive != null)
        {
            ...
            // TODO Implement stall code using these variables.
            //
            if (Math.abs (v_right_front_drive.getCurrentPosition ()) > p_count)
            {
                //
                // Set the status to a positive indication.
                //
